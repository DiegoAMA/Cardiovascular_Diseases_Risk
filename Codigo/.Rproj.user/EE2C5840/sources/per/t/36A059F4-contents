...
#Exportación modelo y parametros para shiny app-----------------------------

parametros <- list(HEART_center = HEART_center,
                   HEART_scale = HEART_scale,
                   table_example = head(train.set))


save(model.rf, file = "model_rf.Rdata")
save(parametros, file = "parametros.Rdata")
